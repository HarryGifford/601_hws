function opt = runClassifier(dataset, opt)
...
%
    ...
    if nargin < 2
        ...
        opt.gamma = 1;         % Kernel parameter for RBF kernel.
    ...
    preds = predictClassifier(opt, X_test);
    ...
    hold on;
    plotBoundary(@(x) predictClassifier(opt, x),...
                 xmin, xmax, ymin, ymax);
